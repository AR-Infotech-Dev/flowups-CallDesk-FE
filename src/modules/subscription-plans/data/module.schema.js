...
export const subscriptionsModuleSchema = {
  ...
  title: "Subscriptions",
  description: "Manage subscriptions, roles, company assignment, and approval access from one place.",
  menu_id: 20,
  primaryKey: 'adminID',
  api: {
    list: "/subscriptions",
  ...
  staticJoined: [
    ...
    // If you have dropdown APIs later, options can be filled dynamically from here.
    {
      field: "roleID",
      fieldtype: "joined",
      joinedTable: "subscription_role_master",
  ...
  defaultColumns: ["name", "subscriptionName", "email", "contactNo", "roleID", "status", "company_id"],
  skipFields: ["subscription_setting", "gfcmToken", "otp", "country_code", "otp_exp_time", "g_cal_token", "one_drive_access_token", "is_google_sync", "is_one_drive_sync", "ftoken", "isVerified", "photo", "adminID", "latitude", "longitude", "roleOfSubscription", "password"],
  tableCellConfig: [
    { column_name: "name", type: "person" },
    { column_name: "subscriptionName", type: "person" },
    { column_name: "roleID", type: "tag" },
    { column_name: "status", type: "badge", color_field: "status_color" },
  ],
  columnMappings: [
    { is_sys_subscription: "System Subscription" },
  ...
  form: {
    ...
    sections: [
      ...
      },
      {
        columns: 3,
        fields: [
          { name: "subscriptionName", label: "Subscription Name", type: "text", required: true, disabled: true, placeholder: "Enter subscription name" },
      ...
      },
      {
        ...
        fields: [
          {
            name: "roleID",
            label: "Subscription Role",
            type: "smartSelect",
            required: true,
            id: "roleID",
            config: {
              apiUrl: "/system/searchList",
              tableName: "subscription_role_master",
      ...
      },
      {
        ...
        fields: [
          ...
          //     type: 'roles',
          //     valueKey: 'role_id',
          //     source: 'subscription_role_master',
          //     statusCheck: true,
  ...
  //   subscriptionName: z.string().min(3, "Subscriptionname must be at least 3 characters"),
  ...
  validationSchema: z.object({
    ...
    subscriptionName: z.string().nullable().refine((val) => val !== null && val.trim() !== "", {
...
export const subscriptionsFallbackColumns = [
  ...FIXED_TABLE_COLUMNS,
  ...buildFallbackColumnsFromKeys(subscriptionsModuleSchema.defaultColumns, {
