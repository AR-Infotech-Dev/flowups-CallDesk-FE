...
export const ticketsModuleSchema = {
  ...
  api: {
    list: "/amctickets",
    delete: "/amctickets/delete",
    create: "/amctickets/create",
    edit: "/amctickets",
  ...
  // kanban: {
  //   enabled: true,
  //   categoryParentSlug: "amcticket_status",
  ...
  //   statusField: "amcticket_status",
  //   idField: "amcticket_id",
  //   titleField: "amcticket_no",
  //   updateApi: "/amctickets/update-status",
  //   appendIdToUpdateApi: true,
  //   updateMethod: "POST",
  //   buildUpdateBody: (row, targetColumnId) => ({
  //     amcticket_status: targetColumnId,
  //   }),
  //   cardFields: [
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          //   required: true,
          //   gridSpan: 6,
          //   // readOnlyWhen: (values) => Boolean(values.amcticket_id),
      ...
      },
      {
        ...
        fields: [
          // {
          //   name: "amcticket_priority",
          //   label: "Priority",
          //   type: "smartSelect",
          //   id: "amcticket_priority",
          //   gridSpan: 6,
          //   config: {
          //     apiUrl: "/system/searchSlugList",
          //     tableName: "categories",
          ...
          //     multi: false,
          //   },
          //   visibleWhen: (values) => Boolean(values.amcticket_id),
          // },
          // {
          ...
          //   placeholder: "Ex. 120",
          //   gridSpan: 6,
          //   readOnlyWhen: (values) => Boolean(values.amcticket_status !== 205),
          // },
        ],
      },
      {
...
export const amcticketsFallbackColumns = [
  ...FIXED_TABLE_COLUMNS,
